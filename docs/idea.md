...
The app is built for student groups and small teams that want lightweight task tracking in the browser.

## Main features (as built in the app)
...
For full specification, see [specification.md](./specification.md).
