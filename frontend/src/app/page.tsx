  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-white dark:from-slate-950 dark:via-slate-950 dark:to-slate-900">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        <span className="text-xl font-bold text-indigo-600">TeamFlow</span>
        <div className="flex gap-3">
          <Link href="/login" className="rounded-lg px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 dark:text-slate-300">
            Sign in
          </Link>
          <Link
      ...
      <main className="mx-auto max-w-6xl px-6 pb-20 pt-12 text-center lg:pt-20">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-2 rounded-xl border border-slate-300 px-6 py-3 font-medium dark:border-slate-700"
          >
            Sign in
          </Link>
        </div>
